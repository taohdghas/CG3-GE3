...
ID3D12DescriptorHeap* CreateDescriptorHeap(
	ID3D12Device* device, D3D12_DESCRIPTOR_HEAP_TYPE heapType, UINT numDescriptors, bool shaderVisivle) {
...
#pragma region Adapterの作成
	...
	for (UINT i = 0; dxgiFactory->EnumAdapterByGpuPreference(i,
		...
		useAdapter = nullptr;//ソフトウェアアダプタの場合は見なかったことに。
	}
...
#pragma endregion
	...
	//まず1つ目を作る。1つ目は最初の所に作る。作る場所を指定してあげる必要がある
...
D3D12_INPUT_ELEMENT_DESC inputElementDescs[2] = {};
	...
	ID3D12Resource* deptjStenciResource = CreateDepthStencilTextureResource(device, kClientWidth, kClientHeight);
	//DSVの設定
